...
const Card = ({ data, onSwipe, cardTimer, maxCardTime }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="card-overlay fake" style={{ opacity: opacityFake }}>FALSO</div>
        <div className="card-overlay real" style={{ opacity: opacityReal }}>VERDADERO</div>
      ...
      <div className="swipe-instruction">
         Desliza Izquierda para Reportar • Desliza Derecha para Compartir
      </div>
